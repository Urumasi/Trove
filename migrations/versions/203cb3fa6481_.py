...
Revision ID: 203cb3fa6481
Revises: None
Create Date: 2015-10-25 21:28:24.651000

"""

# revision identifiers, used by Alembic.
revision = '203cb3fa6481'
down_revision = None
...
def upgrade():
    ...
    op.create_table('cenyd',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('eye', sa.Integer(), nullable=False),
    sa.Column('chest', sa.Integer(), nullable=False),
    sa.Column('cache', sa.Integer(), nullable=False),
    sa.Column('twice', sa.Integer(), nullable=False),
    sa.Column('thrice', sa.Integer(), nullable=False),
    sa.Column('quad', sa.Integer(), nullable=False),
    sa.Column('penta', sa.Integer(), nullable=False),
    sa.PrimaryKeyConstraint('id', name='pk_cenyd'),
    ...
    sa.PrimaryKeyConstraint('id', name='pk_novatabulka'),
    sqlite_autoincrement=True
    )
    op.create_index('ix_novatabulka_prijmeni', 'novatabulka', ['prijmeni'], unique=False)
    op.create_table('drop',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('flux', sa.Integer(), nullable=False),
    sa.Column('eye', sa.Integer(), nullable=False),
    sa.Column('chest', sa.Integer(), nullable=False),
    sa.Column('cache', sa.Integer(), nullable=False),
    sa.Column('twice', sa.Integer(), nullable=False),
    ...
    sa.PrimaryKeyConstraint('id', name='pk_drop'),
    sqlite_autoincrement=True
    )
    ...
    sa.Column('penta', sa.Integer(), nullable=False),
    sa.Column('comment', sa.String(), nullable=False),
    sa.PrimaryKeyConstraint('id', name='pk_den'),
    sqlite_autoincrement=True
    )
...
def downgrade():
    ...
    op.drop_table('drop')
    op.drop_index('ix_novatabulka_prijmeni', table_name='novatabulka')
    op.drop_table('novatabulka')
